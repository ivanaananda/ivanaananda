...
Statement st = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("King Richard", 0, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("REGISTRASI LOGIN");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(username_field, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(nama, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(nama_field, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if(username_field.getText().equals("")||jPasswordField1.getPassword().equals("")||nama_field.getText().equals("")){
                JOptionPane.showMessageDialog(this, "Data Tidak Boleh Kosong!","Warning",JOptionPane.ERROR_MESSAGE);
           hapuslayar();
            }else{
                Class.forName("com.mysql.jdbc.Driver");
                con = DriverManager.getConnection("jdbc:mysql://localhost/db_melan","root","");
                st = con.createStatement();
                String simpan = "login into tbl_login values ('"+username_field.getText()+"','"
                        + String.valueOf(jPasswordField1.getPassword())+"','"+nama_field.getText()+"')'";
                st = con.createStatement();
        ...
        } catch (Exception e) { JOptionPane.showMessageDialog(this, "Akun Sudah Ada!","Warning",JOptionPane.WARNING_MESSAGE);}   
